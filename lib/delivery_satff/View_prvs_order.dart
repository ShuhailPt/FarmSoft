...
void main() {
  runApp(const p_order_view());
}

class p_order_view extends StatelessWidget {
  const p_order_view({super.key});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const p_order_view_page(title: 'ORDER'),
    );
  }
}

class p_order_view_page extends StatefulWidget {
  const p_order_view_page({super.key, required this.title});
  ...
  @override
  State<p_order_view_page> createState() => _p_order_view_pageState();
}

class _p_order_view_pageState extends State<p_order_view_page> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          // Here we take the value from the p_order_view_page object that was created by
  ...
  Future<List<dOrderview>> _getdata() async {
    ...
    var data = await http.post(Uri.parse(Url+"del_prvs_order_view"),body: {
      'lid':lid
    });
    print("------------------------------hoiiiiiii---------------");
    print(data);
