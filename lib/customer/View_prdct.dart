...
class Product_view extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const Product_view_page(title: ''),
    routes: {
...
class Product_view_page extends StatefulWidget {
  const Product_view_page({super.key, required this.title});
...
class _Product_view_pageState extends State<Product_view_page> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        // Here we take the value from the Product_view_page object that was created by
                                ...
                                Navigator.push( context,
                                  MaterialPageRoute(builder: (context) =>  Add_cart_page(title: '',)),);
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Text("Please Give"),TextButton(onPressed: ()async{
                                              final sh = await SharedPreferences.getInstance();
                                              sh.setString("prdct_id", snapshot.data[index].prdct_id);
                                              Navigator.push(
                                                context,
