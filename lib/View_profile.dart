...
void main() {
  runApp(const View_prof());
}

class View_prof extends StatelessWidget {
  const View_prof({super.key});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const View_prof_page(title: ''),
    );
  }
}

class View_prof_page extends StatefulWidget {
  const View_prof_page({super.key, required this.title});
  ...
  @override
  State<View_prof_page> createState() => _View_prof_pageState();
}

class _View_prof_pageState extends State<View_prof_page> {
  String url='';
  String photo='';
  String state='';
  String district='';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          // Here we take the value from the View_prof_page object that was created by
        ...
        body: SingleChildScrollView(
          ...
          children: [
            ...
            SizedBox(height: 10,),
            Text(farmer_name,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 25) ,),
            SizedBox(height: 10,),
            Card(child:
              ListTile(
              ...
              child: Row( mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  ElevatedButton.icon(onPressed: ()async{
                    ...
                    Navigator.push( context,
                      MaterialPageRoute(builder: (context) =>  far_edit_reg_page(title: '',)
                      ),
                ...
                Center(
                  ...
                  ElevatedButton.icon(onPressed: ()async{
                    ...
                    Navigator.push( context,
                      MaterialPageRoute(builder: (context) =>  Edit_pswd_page(title: '',)),);
  ...
  Future<void> _getdata() async {
    ...
    String dis = jsonData['district'].toString();
    String stt = jsonData['state'].toString();
    String ln = jsonData['login_id'].toString();
