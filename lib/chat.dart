...
class MyChatApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(debugShowCheckedModeBanner: false,
      ...
      routes: {
        "/View_officer":(BuildContext context)=>new Officer_view_page(title: ''),
      },
    );
  }
}
...
String name="";
  ...
  Future<void> view_message() async {
    ...
    try {
      ...
      String url="http://"+ip+":5000/view_chat";

      var data = await http.post(Uri.parse(url), body: {'from_id':pref.getString("lid").toString(),'to_id':pref.getString("olid").toString()});
      ...
      appBar: AppBar(
          ...
          leading: new IconButton(
            ...
            onPressed: () {
              ...
              // Navigator.push(context, MaterialPageRoute(builder: (context) => const Officer_view()),);
              print("Hello");
              // Navigator.push(
              //   context,
                  ...
                  FloatingActionButton(
                    onPressed: () async {
                      ...
                      try {
                        ...
                        String url="http://"+ip+":5000/add_chat";

                        var data = await http.post(Uri.parse(url), body: {'message':message,'from_id':pref.getString("lid").toString(),'to_id':pref.getString("olid").toString()});
                        var jsondata = json.decode(data.body);
                        String status = jsondata['status'];
