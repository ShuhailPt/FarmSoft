...
void main() {
  runApp(const News_view());
}

class News_view extends StatelessWidget {
  const News_view({Key? key});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const News_view_page(title: 'NEWS'),
    );
  }
}

class News_view_page extends StatefulWidget {
  const News_view_page({Key? key, required this.title});

  final String title;

  @override
  State<News_view_page> createState() => _News_view_pageState();
}

class _News_view_pageState extends State<News_view_page> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
