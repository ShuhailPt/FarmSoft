...
//       ),
//       home: const demo_homepage(title: 'Farmer demo_Home'),
//       routes: {
...
// }
//
// class demo_homepage extends StatefulWidget {
//   const demo_homepage({super.key, required this.title});
//
//   // This widget is the demo_home page of your application. It is stateful, meaning
...
//
//   @override
//   State<demo_homepage> createState() => _demo_homepageState();
// }
//
//
// class _demo_homepageState extends State<demo_homepage> {
//   // get index => null;
//   //
//   @override
//   void initState() {
...
//       child: Scaffold(
//         appBar: AppBar(
//           // Here we take the value from the demo_homepage object that was created by
...
//                                 colors: [Colors.white54, Colors.green],
...
//                                     Expanded(
//                                       child: Image.asset(
//                                         'assets/images/crop.png', width: 120,
...
//                           Navigator.push(
//                             context,
//                             MaterialPageRoute(builder: (context) => Crop_view()),
//                           );
...
//                           Navigator.push(
//                             context,
//                             MaterialPageRoute(builder: (context) => News_view()),
//                           );
//                           // Add your desired logic for the onPressed callback here
//                           print('Card pressed');
//                         }),
...
//                               'https://cdn-icons-png.flaticon.com/128/881/881760.png')),
//                           SizedBox(height: 10.0),
//                           Text('Users'),
//                         ],
//                       ), // add image
